...
int main() {
    ...
    // (i) GCD:
    int u = 48, v = 18;
    int count_assign_A_1 = 0, count_compare_A_1 = 0;
    int count_assign_A_2 = 0, count_compare_A_2 = 0;
    cout << "(i) Greatest common divisor:" << endl;
    cout << setw(45) << "Result" << setw(17) << "Assignments" << setw(15) << "Comparisons" << endl;
    int res_A_1 = GCD_simple(u, v, count_assign_A_1, count_compare_A_1);
    int res_A_2 = GCD_Euclid(u, v, count_assign_A_2, count_compare_A_2);
    ...
    int count_assign_B_1 = 0, count_compare_B_1 = 0;
    int count_assign_B_2 = 0, count_compare_B_2 = 0;
    cout << "(ii) Longest increasing subsequence:" << endl;
    cout << setw(45) << "Result" << setw(17) << "Assignments" << setw(15) << "Comparisons" << endl;
    int res_B_1 = LIS_simple(a_B, n_B, count_assign_B_1, count_compare_B_1);
    int res_B_2 = LIS_Brute_Force(a_B, n_B, count_assign_B_2, count_compare_B_2);
    ...
    int count_assign_C_1 = 0, count_compare_C_1 = 0;
    int count_assign_C_2 = 0, count_compare_C_2 = 0;
    ...
    int count_assign_D_1 = 0, count_compare_D_1 = 0;
    int count_assign_D_2 = 0, count_compare_D_2 = 0;
